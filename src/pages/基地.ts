...
export class 基地 extends BasePage {
  ...
  routes(): Route[] {
    return [
      ...
      { target: 食堂, action: createRouteAction('images/基地$食堂_1_0.9_726_1006_821_1061.png'), imagePath: 'images/基地$食堂_1_0.9_726_1006_821_1061.png' },
      ...
      { target: 随机事件, action: createRouteAction('images/基地$随机事件_0_0.6_69_1964_126_2026.png'), imagePath: 'images/基地$随机事件_0_0.6_69_1964_126_2026.png' },
    ]
  }
}
